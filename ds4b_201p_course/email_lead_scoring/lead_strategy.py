...
def lead_make_strategy(
    leads_scored_df, thresh = 0.99, for_marketing_team = False, verbose = False
):
...
def lead_score_strategy_optimization(
    ...
    Args:
        ...
        thresh (numpy array, optional): The threshold to optimize. Defaults to np.linspace(0, 1, num=100).
        
        optim_col (str, optional): Optimization column from the strategy table. Defaults to "expected_value".
        
        monthly_sales_reduction_safe_gaurd (float, optional): Managements risk tolerance for reduced sales in month 1 as a percentage of total sales. Defaults to 0.90.
        
        for_marketing_team (bool, optional): produces the lead_strategy_df as a data frame that can be provided to Marketing more easily. Defaults to True.
        
        email_list_size (_type_, optional): Email size. Defaults to 1e5.
        ...
        customer_conversion_rate (float, optional): Percentage of customers that convert on a monthly basis. Defaults to 0.05.
        
        avg_customer_value (int, optional): The average lifetime value of a customer. Defaults to 2000.
        
        highlight_max (bool, optional): Whether or not to add highlighting to the thresh_optim_df table returned. Defaults to True.
        
        highlight_max_color (str, optional): Color for highlight. Defaults to "yellow".
        
        verbose (bool, optional): Whether or not to print progress statements. Defaults to False.
